...
public class ChatLink extends TableImpl<ChatLinkRecord> {
    ...
    /**
     * The column <code>CHAT_LINK.SUBSCRIBED_AT</code>.
     */
    public final TableField<ChatLinkRecord, OffsetDateTime> SUBSCRIBED_AT = createField(DSL.name("SUBSCRIBED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("LOCALTIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public List<ForeignKey<ChatLinkRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONSTRAINT_86, Keys.CONSTRAINT_868);
    }
    ...
    public Link link() {
        if (_link == null)
            _link = new Link(this, Keys.CONSTRAINT_868);

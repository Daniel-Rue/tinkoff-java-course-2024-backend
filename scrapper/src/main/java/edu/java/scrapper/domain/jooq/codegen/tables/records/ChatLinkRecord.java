...
public class ChatLinkRecord extends UpdatableRecordImpl<ChatLinkRecord> implements Record3<Long, Long, OffsetDateTime> {
     ...
     */
    public void setSubscribedAt(@Nullable OffsetDateTime value) {
        set(2, value);
    }
    ...
    public Field<OffsetDateTime> field3() {
        return ChatLink.CHAT_LINK.SUBSCRIBED_AT;
    }
    ...
    @Override
    @NotNull
    public ChatLinkRecord value3(@Nullable OffsetDateTime value) {
    ...
    @Override
    @NotNull
    public ChatLinkRecord values(@NotNull Long value1, @NotNull Long value2, @Nullable OffsetDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    public ChatLinkRecord(@NotNull Long chatId, @NotNull Long linkId, @Nullable OffsetDateTime subscribedAt) {
        super(ChatLink.CHAT_LINK);
     ...
     * Create a detached, initialised ChatLinkRecord
     */
    public ChatLinkRecord(edu.java.scrapper.domain.jooq.codegen.tables.pojos.ChatLink value) {
        super(ChatLink.CHAT_LINK);
